    ...
    <div className="ab">
      <div className="ab-left">
        ...
        <div className="ab-card">
          <img src="../images/labuan8.jpg" alt="" className="ab-img" />
        </div>
      </div>
      <div className="ab-right">
        <h1 className="ab-title">Apa saja yang bisa kita lakukan di Pink Beach?</h1>
        <p className="ab-sub">
        ...
        <div className="ab-award">
          ...
          <div className="ab-award-texts">
            <h4 className="ab-award-title">Biaya Transportasi dan Tiket Masuk</h4>
